# MultiServers
MultiServers was created to simplify the process of creating and hosting local Minecraft servers. User can create server instance and set some basic server settings such as IP address or game difficulty. <br/>
![image](https://user-images.githubusercontent.com/50674232/167146707-fdbd7966-bb2a-4b7f-9566-5527e3d0d51c.png)

# Creating new instance:
To create new instance click + button, select server name and version then click Create.
